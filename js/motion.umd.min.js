...
!(function (t, e) {
  ...
  function at(t, e, n, i = {}, a) {
    ...
    const D = it(e),
      L = (function (t, e) {
        return t.has(e) || t.set(e, new j()), t.get(e);
      })(M.values, D),
      k = q.get(D);
    return (
  ...
  function gt(t) {
    return function (e, n, i = {}) {
      ...
      W(Boolean(r), "No valid element provided."),
        W(Boolean(n), "No keyframes defined.");
      const o = [];
      for (let s = 0; s < r; s++) {
        const a = e[s];
        for (const e in n) {
  ...
  function $t(t, e, { root: n, margin: i, amount: r = "any" } = {}) {
    ...
    const o = lt(t),
      ...
      a = new IntersectionObserver(
        ...
        { root: n, rootMargin: i, threshold: "number" == typeof r ? r : Pt[r] }
      );
  ...
  function Ut(t) {
    return (
      ...
      () => {
        It.delete(t), !It.size && Nt && (Nt = void 0);
      }
    );
  }
  function _t(t, e) {
    return v(t) ? Ut(t) : Ht(t, e);
  }
  const Gt = 50,
    Zt = {
    ...
    (t.createMotionState = function (t = {}, e) {
      ...
      const f = Object.assign({}, l),
        ...
        p = {
          ...
          getContext: () => a,
          mount: (t) => (
            W(Boolean(t), "Animation state must be mounted with valid Element"),
            (i = t),
            xe.set(i, p),
            d(),
            () => {
